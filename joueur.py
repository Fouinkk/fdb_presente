...
class Joueur:
    ...
    def __init__(self, nom):
        ...
        *** Vous n'avez pas à coder cette méthode. ***
        ...
        #self.chevalet = [None, None, Jeton('A', 2), Jeton('S', 3), None, None, Jeton('A', 2)]
    ...
    def position_est_valide(self, position):
        ...
        #if 0 < position < 8:
            #return f'Position {position}, est valide'
        #else:
            #return f"Position {position}, n'est pas valide"
    ...
    def position_est_vide(self, position):
        ...
        if self.chevalet[position] is None:
            return f'La position {position}, est vide'
        else:
            return f"La position {position}, n'est pas vide"
    ...
    def retirer_jeton(self, position):
        ...
        if self.chevalet[position] is not None:
            return self.chevalet
    ...
    def melanger_jetons(self):
        ...
        return random.shuffle(self.chevalet)
...
if __name__ == '__main__':
    ...
    j = Joueur('Jonathan')
    j.chevalet = [None, 5, None, None, None, None, None]
    print(j.nb_a_tirer())
    print(j.position_est_valide(1))
    print(j.obtenir_jeton(2))
    print(j.position_est_vide(6))
    j.points = 5
    print(j.points)
    print(j.chevalet)
    j.melanger_jetons()
